...
@router.put("/schedules/{schedule_name}", response_model=Dict[str, Any])
@leader_only
@rate_limit
...
@router.delete("/schedules/{schedule_name}", response_model=Dict[str, Any])
@leader_only
@rate_limit
...
@router.post("/schedules/{schedule_name}/run", response_model=Dict[str, Any])
@leader_only
@rate_limit
