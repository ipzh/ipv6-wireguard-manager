...
@router.get("/nodes/healthy", response_model=List[Dict[str, Any]])
@rate_limit
...
@router.post("/nodes/{node_id}/health-check", response_model=Dict[str, Any])
@rate_limit
...
@router.post("/nodes/health-check-all", response_model=Dict[str, Any])
@rate_limit
...
@router.get("/leader", response_model=Dict[str, Any])
@rate_limit
...
@router.post("/leader/elect", response_model=Dict[str, Any])
@rate_limit
...
@router.put("/load-balancer/strategy", response_model=Dict[str, Any])
@leader_only
@rate_limit
...
@router.post("/load-balancer/select-node", response_model=Dict[str, Any])
@rate_limit
...
@router.post("/tasks/distribute", response_model=Dict[str, Any])
@leader_only
@rate_limit
