...
Endpoint = your-server.com:${WG_PORT}
...
├─────────────────────────────────────────────────────────────┤
│ ${EXAMPLE_NETWORK} │ 192.168.1.1   │ 65000   │ 65000:100│ 活跃  │ [管理]│
...
├─────────────────────────────────────────────────────────────┤
│ ${SERVER_HOST}/0     │ 192.168.1.1 │ eth0 │ 默认  │ 0      │ 活跃 │ [管理]│
│ 1${SERVER_HOST}/24   │ ${SERVER_HOST}     │ wg0  │ 直连  │ 0      │ 活跃 │ [管理]│
│ 10.0.1.0/24   │ ${SERVER_HOST}     │ wg1  │ 直连  │ 0      │ 活跃 │ [管理]│
│ ${EXAMPLE_NETWORK}│ ${SERVER_HOST}     │ eth0 │ 直连  │ 0      │ 活跃 │ [管理]│
└─────────────────────────────────────────────────────────────┘
```
